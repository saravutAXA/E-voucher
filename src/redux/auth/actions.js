...
export const forgetAccessToken = (scope: string,grantType: string,clientId: string,clientSecret: string): AuthAction => ({
    type: FORGET_ACCESS_TOTKEN,
    payload: { scope, grantType,clientId,clientSecret }
});